...
def maps(request):
    try:
        data = pd.read_csv('D:/College Assignment/Mega Project/FIPPS (2)/FIPPS/fips/static/model/inundation_mini copy.csv')
...
# Append the original and augmented dataframes
        ...
        augmented_dataset.to_csv('InundationDataset.csv', index = False, encoding='utf-8')
